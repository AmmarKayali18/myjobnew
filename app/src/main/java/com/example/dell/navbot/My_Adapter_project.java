...
public class My_Adapter_project extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    String  idworker , idcompany;

    public My_Adapter_project(itemdata_project[] itemdata_projects, Context context,String idworker,String idcompany) {
